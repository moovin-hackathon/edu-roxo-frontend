    ...
    getLists : function() {
        $.ajax({
            ...
            $.each(data, function(id, value){
                item += '<div class="col">'+
                (value.type == 'admin' ? ('<a href="javascript:void(0)" class="thumbnail" data-target="#password" data-toggle="modal">') : ('<a href="lobby-user.html?user='+value._id+'&profileId='+value._id+'" class="thumbnail">'))+
